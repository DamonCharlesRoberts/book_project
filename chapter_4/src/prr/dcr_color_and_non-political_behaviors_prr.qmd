...
To test these hypotheses, I conduct an experiment involving a fictional real estate posting. The treatment involves randomly assigning participants to view one of two versions of a fictional real estate posting. The characteristics of the neighborhood are exactly the same between the two conditions except for the "favorite color of car" in the neighborhood. In the first condition the "favorite color of car" is reported by displaying a red swatch. In the second condition, the "favorite color of car" reported by displaying a blue swatch. Participants are presented with a Likert scale to indicate, "How much would [they] like to live in this neighborhood?" 
