...
code-repo: |
  For replication, go to: <https://github.com/DamonCharlesRoberts/book_project/chapter_3>.
author:
...
bibliography: ["../../../assets/deliberation-chapter-references.bib"]
format:
  hikmah-pdf:
