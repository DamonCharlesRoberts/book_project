...
abstract: |
  Do the colors red and blue convey political information? If so, how do they shape candidate preferences and vote choice? Political psychologists rely on interdisciplinary approaches to construct theories of how we process political information. Likewise, those who study visual political information come from a number of disciplinary traditions to study how politics may be conveyed visually. As these groups of scholars are working in parallel, they have yet to fully integrate their work to construct a theory explaining the cognitive and behavioral consequences of visual information on political attitude expression and behavior. In this chapter, I present a snap-judgment model of visual information processing to demonstrate how visual information efficiently conveys substantive political information. Specifically, I focus on a simple but obvious case that we only have anecdotal and descriptive evidence of: the association between Republicans with the color red and Democrats with the color blue. First, I use supervised machine learning that does a pixel-by-pixel classification of the color on yard signs used by campaigns for the U.S. House of Representatives from 2016 to 2020 and merge this with election return data from the MIT Election Labs. From these data, I find that systematic descriptive evidence of campaigns using more red in their yard signs in districts that are safe for Republicans and campaigns using more blue in their yard signs in districts that are safe for Democrats. Next, I turn to an experiment to examine whether these associations of the colors red and blue with Republicans and Democrats exist among voters and whether it shapes attitude expression and behavior. I find that these associations of the color red with Republicans and the color blue with Democrats do exist among the public and that these associations are strong enough to shape support for political candidates. This chapter advances our understanding in a few areas: that visual information is a pre-conscious form of information that we should integrate with our models of information processing that consider more traditional forms of political information, provides a cognitive mechanism to explain how the public have come to associate the colors red and blue with the two dominant political parties, as well as demonstrates that these cognitive processes are capable of influencing behavior as important as vote choice.
additional-info: |
