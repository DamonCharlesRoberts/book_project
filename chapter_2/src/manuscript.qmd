...
In the [first study](#study-1), I find that individuals do shift their perceptions of political candidates in response to the use of the colors red and blue -- they consistently and strongly associate Republicans with the color red and Democrats with the color blue, and their willingness to vote for a candidate can be dramatically different depending on whether the color used aligns with their partisan identification. The [second study](#study-2) suggests that candidates in districts where Democrats have a higher vote share use more blue on their yard signs (while also using less red).
...
After exploring the image in each trial, I ask participants whether they felt that the candidate supposedly owning the yard sign was a Democrat, a Republican, or Neither. After completing the three trials, I ask subjects to indicate their preference among the three images (one from each trial). 
...
Once I have fit these models, I use the `marginaleffects` [@arel-bundock_marginaleffects_2022] package to calculate the grand mean of the predicted proportion of the use of the color red or blue for these yard signs, as explained by the 5-year rolling average Democratic candidates' vote share. The grand mean here reflects that I am not showing the predicted proportion of the use of these outcomes for each state-district, but rather that I am averaging across all districts to provide a single line in my figure. These results are included in @fig-study-2-pred.
