...
From this discussion, I developed the following pre-registered hypotheses: that the average potential voter pays attention to the colors used in campaign branding ($H_{1}$); that colors observed shape perceptions about the person and ideological symbol represented in the branding -- this means that individuals express different levels of preference for receiving more information that is consistent with their preferences ($H_{2}$); that the consistency of information explains more positive perceptions (i.e., simple visual information paired with more complex "traditional" information) ($H_{3}$); positive and consistent information is processed more quickly than negative and inconsistent, negative and consistent, and positive and inconsistent information ($H_{4}$); and finally that campaigns make strategic choices about their branding to attract voters ($H_{5}$) -- this is inline with their primary objective of reelection [@fenno_congressmen_1973;@mayhew_congress_1974]. A summary of these hypotheses is presented in @tbl-hypotheses.

## Study 1

In [Study 1](#study-1) I start with testing $H_5$. In some informal conversations that I had with political campaign professionals, it became clear that the descriptive evidence connecting the colors red and blue with Republicans and Democrats is still very much based on experience.
...
It appears that campaigns recognize that these are not simply patterns that journalists [see @elving_color_2014] and researchers [see @williams_whats_2022] have picked up on, bit that they are associations held by voters and campaigns respond accordingly:
...
The results demonstrate that districts where Democrats are historically more successful see yard signs with a lower proportion of red on them, while those same districts see more blue on them. Again, these empirical results do not claim that campaigns are doing this either because voters are encouraging them to take this strategy, or that they are doing it as a way to proactively get voters to make these associations. My informal conversation does seem to indicate that campaigns are responding to associations that exist in the brains of voters already as opposed to undertaking efforts to generate such associations or to strengthen them. Though my empirical evidence is consistent with the argument that campaigns systematically vary in their use of color depending on electoral context, it remains descriptive and I cannot directly test "strategy." To tease out which of those questions is the right one requires more sophisticated approaches and data that could allow me to leverage redistricting (to see how these outcomes change due to some unrelated, external shock). The data available to me do not allow me to do that at this time. While this is a useful way to understand how these associations of the colors red and blue with Republicans and Democrats exist at a macro-level, this project is fundamentally curious about how these associations have come to be formed among the public and what their consequences are for attitude expression and behavior. [Study 2](#study-2) is a test of these central questions in the context of elections.
...
I recruited participants from Prolific.[^color_influence_pre-reg_anon-3] After providing informed consent to participate in the study, Prolific redirects subjects to Pavlovia,[^color_influence_pre-reg_anon-4] where individuals are provided with a demographics and political attitudes questionnaire. As I am concerned about priming effects introduced by these questions, while I am simultaneously concerned about bias introduced by post-treatment control [@montgomery_how_2018], I randomly selected half of the participants to receive the questionnaire post-treatment and the other half receive it pre-treatment. This questionnaire included common questions about the participant's ascriptive characteristics, and about the participant's political ideology, partisan identification, interest in politics, patriotism, and political knowledge.

[^color_influence_pre-reg_anon-3]: I paid subjects a rate of \$12.00 per hour. On top of the price per participant, Prolific charged a 30% servicing fee.

[^color_influence_pre-reg_anon-4]: Pavolovia allows for researchers to host and run open source experiments for about \$0.20 per participant (to cover their server costs). I used it primarily to integrate the JavaScript components from the jsPsych package [@leeuw_jspsych_2015] for my experimental design.
...
Digging in a little bit more about what these perceptions were, the predicted probability that subjects perceived the candidate with a red yard sign to be Republican is around 70%, whereas it is only about 30% when viewing a white yard sign. When given a red yard sign, the predicted probability the candidate is marked to be an independent is about 30% and less than 5% to be a Democrat. However, when viewing a blue yard sign, the predicted probability of a subject perceiving the candidate to be a Democrat is at about 50% whereas it is less at about 10% with a white yard sign. When viewing a blue yard sign, the predicted probability of subjects perceiving the candidate to be a Republican is less than 20% and about 45% to be an Independent. The full results are reported in @tbl-hypothesis-2-main in the [Appendix](#sec-2-a).
