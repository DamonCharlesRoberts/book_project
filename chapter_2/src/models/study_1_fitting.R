...
# Hypothesis 2
    #* Fit models
list_fitted[["h_2"]][["red_multinomial"]] <- brm(
...
list_fitted[["h_2"]][["blue_multinomial"]] <- brm(
...
list_fitted[["h_2"]][["red_ordinal"]] <- brm(
  formula = trial_1_party ~ trial_1_red_stimuli
  , data = list_df[["cleaned"]]
...
list_fitted[["h_2"]][["blue_ordinal"]] <- brm(
  formula = trial_1_party ~ trial_1_blue_stimuli
  , data = list_df[["cleaned"]]
  , family = cumulative(link = "logit")
  , prior = set_prior("normal(0, 1)", class = "b")
...
list_ppc[["h_2"]][["red_multinomial"]] <- pp_check(
  list_fitted[["h_2"]][["red_multinomial"]]
)
list_ppc[["h_2"]][["blue_multinomial"]] <- pp_check(
  list_fitted[["h_2"]][["blue_multinomial"]]
)
list_ppc[["h_2"]][["red_ordinal"]] <- pp_check(
  list_fitted[["h_2"]][["red_ordinal"]]
)
list_ppc[["h_2"]][["blue_ordinal"]] <- pp_check(
  list_fitted[["h_2"]][["blue_ordinal"]]
)
...
# Hypothesis 2a
    #* Fit the models
list_fitted[["h_2a"]][["trial_2_red_multinomial"]] <- brm(
...
list_fitted[["h_2a"]][["trial_2_blue_multinomial"]] <- brm(
...
list_fitted[["h_2a"]][["trial_2_red_ordinal"]] <- brm(
  formula = trial_2_party ~ trial_2_red_stimuli
  , data = list_df[["cleaned"]]
  , family = cumulative(link = "logit")
  , prior = set_prior("normal(0, 1)", class = "b")
...
list_fitted[["h_2a"]][["trial_2_blue_ordinal"]] <- brm(
  formula = trial_2_party ~ trial_2_blue_stimuli
  , data = list_df[["cleaned"]]
  , family = cumulative(link = "logit")
  , prior = set_prior("normal(0, 1)", class = "b")
...
list_fitted[["h_2a"]][["trial_3_red_multinomial"]] <- brm(
...
list_fitted[["h_2a"]][["trial_3_blue_multinomial"]] <- brm(
...
list_fitted[["h_2a"]][["trial_3_red_ordinal"]] <- brm(
    formula = trial_3_party ~ trial_3_red_stimuli
    , data = list_df[["cleaned"]]
    , family = cumulative(link = "logit")
    , prior = set_prior("normal(0, 1)", class = "b")
...
list_fitted[["h_2a"]][["trial_3_blue_ordinal"]] <- brm(
    formula = trial_3_party ~ trial_3_blue_stimuli
    , data = list_df[["cleaned"]]
    , family = cumulative(link = "logit")
    , prior = set_prior("normal(0, 1)", class = "b")
...
list_fitted[["h_2a"]][["trial_3_single_model"]] <- brm(
  ...
  , backend = "cmdstanr"
    ...
    #* Posterior predictive checks
list_ppc[["h_2a"]][["trial_2_red_multinomial"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_2_red_multinomial"]]
)
list_ppc[["h_2a"]][["trial_2_blue_multinomial"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_3_blue_multinomial"]]
)
list_ppc[["h_2a"]][["trial_2_red_ordinal"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_2_red_ordinal"]]
)
list_ppc[["h_2a"]][["trial_2_blue_ordinal"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_3_blue_ordinal"]]
)
list_ppc[["h_2a"]][["trial_2_single_model"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_2_single_model"]]
)
list_ppc[["h_2a"]][["trial_3_red_multinomial"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_3_red_multinomial"]]
)
list_ppc[["h_2a"]][["trial_3_blue_multinomial"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_3_blue_multinomial"]]
)
list_ppc[["h_2a"]][["trial_3_red_ordinal"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_3_red_ordinal"]]
)
list_ppc[["h_2a"]][["trial_3_blue_ordinal"]] <- pp_check(
  list_fitted[["h_2a"]][["trial_3_blue_ordinal"]]
)
